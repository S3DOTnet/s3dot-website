      ...
      <div className="relative max-w-[1200px] mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center mb-12 md:mb-16">
          ...
          <motion.h2
            ...
            className="font-bold text-white mb-4" style={{ fontSize: "clamp(1.4rem, 3.4vw, 2.4rem)", lineHeight: 1.45 }}
          >
          ...
          {benefits.map((b, i) => {
            ...
            return (
              <motion.div
                ...
                className="card-luxury card-shine rounded-xl p-6 md:p-7 relative overflow-hidden"
              >
                ...
                <p className="font-mono mb-4" style={{ fontSize: "0.72rem", color: `${b.color}99`, letterSpacing: "0.1em" }}>{b.num}</p>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-4" style={{ background: `${b.color}1A`, border: `1px solid ${b.color}40` }}>
                  <Icon size={19} style={{ color: b.color }} />
                </div>
                <h3 className="text-white font-bold mb-2" style={{ fontSize: "1.05rem" }}>{b.title}</h3>
